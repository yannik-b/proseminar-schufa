...
\usepackage[%
    bookmarks,%
    bookmarksopen=true,% Klappt die Bookmarks in Acrobat aus
...
%\href{url}{https://books.google.de/books?id=m1kpBAAAQBAJ&lpg=PA33&ots=iIp83FquRf&dq=bewag%20haushaltsger%C3%A4te&hl=de&pg=PA33#v=onepage&q=bewag%20haushaltsger%C3%A4te&f=false}
%https://www.schufa.de/de/unternehmenskunden/leistungen/fraudprevention-compliance/schufa-identitaetscheck-jugendschutz/
\end{document}
